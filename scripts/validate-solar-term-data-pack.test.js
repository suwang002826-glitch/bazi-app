...
assert.strictEqual(result.summary.calendarDataVersion, 'hko-solar-term-data-pack@2026.07.03-runtime-preview.1');
...
assert.deepStrictEqual(result.summary.runtimeEnabledPackIds, ['hko-solar-terms-2024-2026-candidate']);
